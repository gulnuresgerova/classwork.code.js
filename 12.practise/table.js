...
let leman = document.querySelector(".name");
let asc = document.querySelector(".asc");
///////////////////////////////////////////////////////////////////
ascending.style.color = "black";
ascending.style.backgroundColor = "pink";
ascending.style.width = "150px";
ascending.style.height = "30px";
ascending.style.border = "1px solid black";
///////////////////////////////////////////////////////////////////
descending.style.color = "black";
descending.style.backgroundColor = "pink";
descending.style.width = "150px";
descending.style.height = "30px";
descending.style.border = "1px solid black";
///////////////////////////////////////////////////////////////////
asc.style.color = "black";
asc.style.backgroundColor = "pink";
asc.style.width = "150px";
asc.style.height = "30px";
asc.style.border = "1px solid black";
///////////////////////////////////////////////////////////////////
leman.style.color = "black";
leman.style.backgroundColor = "pink";
leman.style.width = "100px";
leman.style.height = "30px";
leman.style.border = "1px solid black";
///////////////////////////////////////////////////////////////////
...
leman.addEventListener("click", function () {
 let sort = users.sort((a, b) => a.first_name.localeCompare(b.first_name));
  drawTable(sort);
});
